  ...
  return (
    <div className="Grid-Employer-Card">
      ...
      <div className="Item-Employer-Card-2 Item ks-container color-2-yellow">
        ...
        <textarea id="seekingOrSkillsInputBox" name="newSeekingOrSkills" type="text" rows="3" placeholder="..." className="desc-input form-control" onChange={this.props.onChange} value={this.props.newSeekingOrSkills}>{this.props.seekingOrSkills}</textarea>
